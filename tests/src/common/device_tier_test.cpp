...
TEST(DeviceTierTests, ValidTiers) {
	EXPECT_TRUE(device_tier::IsValid(device_tier::standard));
	EXPECT_TRUE(device_tier::IsValid(device_tier::system));
	EXPECT_TRUE(device_tier::IsValid(device_tier::micro));
}
...
TEST(DeviceTierTests, TierValues) {
	EXPECT_EQ(device_tier::standard, "standard");
	EXPECT_EQ(device_tier::system, "system");
	EXPECT_EQ(device_tier::micro, "micro");
}
