...
func (te *testExecutor) ExecuteAll(state, action string, ignoreError bool, report *api.StatusReportWrapper) error {
...
func (e *checkIgnoreErrorsExecutor) ExecuteAll(state, action string, ignoreError bool, report *api.StatusReportWrapper) error {
