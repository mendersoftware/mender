...
func (t Transition) Enter(exec statescript.Executor, report *api.StatusReportWrapper, store store.Store) error {
	if t == ToNone {
		return nil
	}
...
func (t Transition) Leave(exec statescript.Executor, report *api.StatusReportWrapper, store store.Store) error {
	if t == ToNone {
		return nil
	}
...
func (t Transition) Error(exec statescript.Executor, report *api.StatusReportWrapper) error {
	if t == ToNone {
		return nil
	}
