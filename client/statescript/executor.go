...
type Executor interface {
	ExecuteAll(state, action string, ignoreError bool, report *api.StatusReportWrapper) error
...
func reportScriptStatus(rep *api.StatusReportWrapper, statusReport string) error {
	c := api.NewStatus()

	return c.Report(rep.API, api.StatusReport{
...
func (l Launcher) ExecuteAll(state, action string, ignoreError bool,
	report *api.StatusReportWrapper) error {
