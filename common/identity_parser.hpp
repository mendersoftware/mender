...
enum IdentityParserErrorCode {
	InvalidData,
	SpawnError,
};

using IdentityParserError = mender::common::error::Error<IdentityParserErrorCode>;
using ExpectedKeyValuesMap =
	mender::common::expected::Expected<kvp::KeyValuesMap, IdentityParserError>;
