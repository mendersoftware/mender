...
public:
	...
	unique_ptr<EVP_PKEY, void (*)(EVP_PKEY *)> pkey;

private:
	PrivateKey(unique_ptr<EVP_PKEY, void (*)(EVP_PKEY *)> &private_key) : pkey(std::move(private_key)){};
	static int CapturePrivateKeyPassphrase(char *buf, int size, int rwflag, void *u);
